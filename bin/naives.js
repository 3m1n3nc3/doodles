...
import { makeGenome, describe } from '../src/genome.js';
...
if (cmd === 'face') {
  ...
  const list = all[cat];
  if (!list) { console.error(`unknown category. try: ${Object.keys(all).join(', ')}`); process.exit(1); }
